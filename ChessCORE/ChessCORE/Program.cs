    ...
    internal class Init
    {
        ...
        public static void SettingsMenu(int start)
        {
            ...
            [
                ...
                new($"(RENDERER) USE LOW-RENDER                        {GetState(board_visual.low_render)}",() => updateVar(11,board_visual.low_render,out board_visual.low_render),() => updateVar(11,board_visual.low_render,out board_visual.low_render),() => updateVar(11,board_visual.low_render,out board_visual.low_render)),
                ...
                new($"(PHYSICAL) DO CALIBRATION                        {GetState(Database.Physical.calib)}",() => updateVar(13,Database.Physical.calib,out Database.Physical.calib),() => updateVar(13,Database.Physical.calib,out Database.Physical.calib),() => updateVar(13,Database.Physical.calib,out Database.Physical.calib)),
