    ...
    internal class Init
    {
        ...
        public static void SettingsMenu(int start)
        {
            ...
            [
                ...
                new($"(PYHSICAL) AUTO IGNORE                           {GetState(Database.Physical.ignore)}",() => updateVar(18,Database.Physical.ignore,out Database.Physical.ignore),() => updateVar(18,Database.Physical.ignore,out Database.Physical.ignore),() => updateVar(18,Database.Physical.ignore,out Database.Physical.ignore)),
                new($"(MCU)      LAUNCH RE-SELFTEST                    {GetState(Database.Physical.repeat_selftest)}",() => updateVar(19,Database.Physical.repeat_selftest,out Database.Physical.repeat_selftest),() => updateVar(19,Database.Physical.repeat_selftest,out Database.Physical.repeat_selftest),() => updateVar(19,Database.Physical.repeat_selftest,out Database.Physical.repeat_selftest)),
