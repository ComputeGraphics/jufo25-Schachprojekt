    ...
    internal class Init
    {
        ...
        public static void SettingsMenu(int start)
        {
            ...
            [
                ...
                new($"(RENDERER) SHOW MAGNETIC                         {GetState(board_visual.show_magnetic)}",() => updateVar(9,board_visual.show_magnetic,out board_visual.show_magnetic),() => updateVar(9,board_visual.show_magnetic,out board_visual.show_magnetic),() => updateVar(9,board_visual.show_magnetic,out board_visual.show_magnetic)),
                new($"(PHYSICAL) TOLERANCE                             {Database.Physical.tolerance}",() => WriteTemporaryMessage("Please use Arrowkeys to Adjust Value"),() => changer(11,true,standard_tolerance.IndexOf(Database.Physical.tolerance),standard_tolerance,out Database.Physical.tolerance),() => changer(11,false,standard_tolerance.IndexOf(Database.Physical.tolerance),standard_tolerance,out Database.Physical.tolerance)),
                new($"(PHYSICAL) DO CALIBRATION                        {GetState(Database.Physical.calib)}",() => updateVar(12,Database.Physical.calib,out Database.Physical.calib),() => updateVar(12,Database.Physical.calib,out Database.Physical.calib),() => updateVar(12,Database.Physical.calib,out Database.Physical.calib)),
                new($"(PHYSICAL) CALIBRATION RESOLUTION                {Database.Physical.default_calib}",() => WriteTemporaryMessage("Please use Arrowkeys to Adjust Value"),() => changer(13,true,standard_resolutions.IndexOf(Database.Physical.default_calib),standard_resolutions,out Database.Physical.default_calib),() => changer(13,false,standard_resolutions.IndexOf(Database.Physical.default_calib),standard_resolutions,out Database.Physical.default_calib)),
                new($"(PHYSICAL) DEFAULT CALIB AV                      {Database.Physical.default_av}",() => enterVar(14,out Database.Physical.default_av),() => changer(14,true,caav.IndexOf(av),caav,out Database.Physical.default_av),() => changer(14,false,caav.IndexOf(av),caav,out Database.Physical.default_av)),
                new($"(PYHSICAL) DO AUTO RECALIB                       {GetState(Database.Physical.recalib)}",() => updateVar(15,Database.Physical.recalib,out Database.Physical.recalib),() => updateVar(15,Database.Physical.recalib,out Database.Physical.recalib),() => updateVar(15,Database.Physical.recalib,out Database.Physical.recalib)),
                new($"(MCU)      LAUNCH RE-SELFTEST                    {GetState(Database.Physical.repeat_selftest)}",() => updateVar(15,Database.Physical.repeat_selftest,out Database.Physical.repeat_selftest),() => updateVar(15,Database.Physical.repeat_selftest,out Database.Physical.repeat_selftest),() => updateVar(15,Database.Physical.repeat_selftest,out Database.Physical.repeat_selftest)),
