    ...
    internal class Init
    {
        ...
        public static void SettingsMenu(int start)
        {
            ...
            [
                ...
                new($"(Physical) DO CALIBRATION                        {GetState(Database.Physical.calib)}",() => updateVar(11,Database.Physical.calib,out Database.Physical.calib),() => updateVar(11,Database.Physical.calib,out Database.Physical.calib),() => updateVar(11,Database.Physical.calib,out Database.Physical.calib)),
