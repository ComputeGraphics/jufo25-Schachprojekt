...
void qgetRange(int request, bool loop) {
        ...
        Serial.println(qget(request, false));
        Serial.println(qget(request + 1, false));
        Serial.println(qget(request + 2, false));
        Serial.println(qget(request + 3, false));
        Serial.println(qget(request + 4, false));
        Serial.println(qget(request + 5, false));
        Serial.println(qget(request + 6, false));
        Serial.println(qget(request + 7, false));
